...
public class CategorizeResponse {
  ...
  private CategorizeDocument data = null;

  public CategorizeResponse success(Boolean success) {
  ...
  **/
  ...
  public CategorizeResponse errors(List<ServiceError> errors) {
    this.errors = errors;
    return this;
  }

  public CategorizeResponse addErrorsItem(ServiceError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public CategorizeResponse data(CategorizeDocument data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  public CategorizeDocument getData() {
    return data;
  }

  public void setData(CategorizeDocument data) {
    this.data = data;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CategorizeResponse categorizeResponse = (CategorizeResponse) o;
    return Objects.equals(this.success, categorizeResponse.success) &&
        Objects.equals(this.errors, categorizeResponse.errors) &&
        Objects.equals(this.data, categorizeResponse.data);
  }
